...
public class SecurityConfig {
    ...
    // here we are specifying that we don't want spring security to use any of the password encoder during authentication
    // it is mandatory to provide PasswordEncoder bean even if we aren't using any PasswordEncoder
    @Bean
